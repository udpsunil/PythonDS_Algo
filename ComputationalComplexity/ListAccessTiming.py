...
def main():
    ...
    for x in range(xmin, xmax + 1, 1000):
        ...
        # let any garbage collection/memory allocation complete or atleast settle down.
        time.sleep(1)
    ...
    # This part of the program tests access at 100 random locations within a list of 200,000 elements to see that all
    # the locations can be accessed in about the same amount of time.
    xList = lst
    yList = [0] * 200000
